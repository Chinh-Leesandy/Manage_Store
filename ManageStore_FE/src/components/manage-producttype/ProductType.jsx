    ...
    <div className='container'>
      ...
      <div className="row g-3 col-7 mx-auto p-3">
        <div className="col-md-6">
          ...
          {validation.ten && <div className="invalid-feedback">{validation.ten}</div>}
        </div>
        <div className="col-md-6">
          ...
          {validation.ncc && <div className="invalid-feedback">{validation.ncc}</div>}
        </div>
        <div className="col-md-6">
        ...
        <div className="col-md-6">
          ...
          {validation.soluong && <div className="invalid-feedback">{validation.soluong}</div>}
        </div>
