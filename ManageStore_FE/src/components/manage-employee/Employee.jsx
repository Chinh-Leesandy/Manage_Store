  ...
  const validateForm = () => {
    ...
    if (employee.password === '' || !employee.password) {
      ...
      if (employee.password.length < 8) {
        newvalidate.password = "Mật khẩu phải có ít nhất 8 ký tự.";
      }
      if (!/[a-z]/.test(employee.password)) {
        newvalidate.password = "Mật khẩu phải chứa ít nhất một chữ viết thường.";
      }
      if (!/[A-Z]/.test(employee.password)) {
        newvalidate.password = "Mật khẩu phải chứa ít nhất một chữ viết hoa.";
      }
      if (!/\d/.test(employee.password)) {
        newvalidate.password = "Mật khẩu phải chứa ít nhất một số.";
      }
      if (!/\W/.test(employee.password)) {
        newvalidate.password = "Mật khẩu phải chứa ít nhất một ký tự đặc biệt.";
      }
    }
    ...
    <div className='container'>
        ...
        <div className="row g-3 col-7 mx-auto p-3">
          <div className="col-md-6">
            ...
            {validation.hoten && <div className="invalid-feedback">{validation.hoten}</div>}
          </div>
          <div className="col-md-6">
            ...
            {validation.sdt && <div className="invalid-feedback">{validation.sdt}</div>}
          </div>
          <div className="col-md-6">
          ...
          <div className="col-md-6">
            ...
            {validation.diachi && <div className="invalid-feedback">{validation.diachi}</div>}
          </div>
          <div className="col-12">
            ...
            {validation.chucvu && <div className="invalid-feedback">{validation.chucvu}</div>}
          </div>
          <div className="col-md-6">
